      ...
      <div className="min-h-screen bg-black">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400">{selectedInspection.registrationNumber} - #{selectedInspection.id}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className={`px-3 py-1 rounded-full border flex items-center gap-2 ${getStatusColor(selectedInspection.approvalStatus)}`}>
                {getStatusIcon(selectedInspection.approvalStatus)}
                <span className="font-semibold">{selectedInspection.approvalStatus}</span>
              </div>
              {selectedInspection.isEdited && (
                <div className="bg-orange-500/20 border border-orange-500/30 text-orange-400 px-3 py-1 rounded-full text-sm font-semibold">
        ...
        <div className="px-8 pb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-6">Inspection Information</h2>
              
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-gray-400">Registration:</span>
                  <span className="text-white font-semibold">{selectedInspection.registrationNumber}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Status:</span>
                  <span className="text-white font-semibold">{selectedInspection.status}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">PDF Ready:</span>
                  <span className="text-white font-semibold">{selectedInspection.pdfReady ? 'Yes' : 'No'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Created:</span>
                  <span className="text-white font-semibold">{formatDate(selectedInspection.createdAt)}</span>
                </div>
                {selectedInspection.completedAt && (
                  <div className="flex justify-between">
                    <span className="text-gray-400">Completed:</span>
                    <span className="text-white font-semibold">{formatDate(selectedInspection.completedAt)}</span>
                  </div>
                )}
                {selectedInspection.totalDamagePercentage !== null && (
                  <div className="flex justify-between">
                    <span className="text-gray-400">Damage:</span>
                    <span className="text-white font-semibold">{selectedInspection.totalDamagePercentage}%</span>
                  </div>
                )}
                {selectedInspection.estimatedCost !== null && (
                  <div className="flex justify-between">
                    <span className="text-gray-400">Cost:</span>
                    <span className="text-white font-semibold">{formatCurrency(selectedInspection.estimatedCost)}</span>
                  </div>
                )}
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                <h3 className="text-xl font-bold text-white mb-4">Report Actions</h3>
                ...
                <div className="space-y-3">
                  <motion.button
                    ...
                    className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-3"
                  >
                  ...
                  <motion.button
                    ...
                    className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-3"
                  >
              ...
              {selectedInspection.approvalStatus === 'PENDING' && (
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                  <h3 className="text-xl font-bold text-white mb-4">Approval Actions</h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:border-blue-400 focus:outline-none resize-none"
                    ...
                    <div className="flex gap-3">
                      <motion.button
                        ...
                        className="flex-1 bg-green-500 hover:bg-green-600 disabled:bg-gray-500 text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-3"
                      >
                      ...
                      <motion.button
                        ...
                        className="flex-1 bg-red-500 hover:bg-red-600 disabled:bg-gray-500 text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-3"
                      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">Manage car inspections and approvals</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-white font-semibold text-lg">{filteredInspections.length} Inspections</p>
            <p className="text-gray-400 text-sm">{viewMode === 'pending' ? 'Pending' : 'All'}</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/20 rounded-xl pl-10 pr-4 py-3 text-white placeholder-gray-400 focus:border-blue-400 focus:outline-none"
              />
            </div>
          </div>
        </div>
              ...
              {filteredInspections.map((inspection, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className={`px-3 py-1 rounded-full border flex items-center gap-2 ${getStatusColor(inspection.approvalStatus)}`}>
                      {getStatusIcon(inspection.approvalStatus)}
                      <span className="font-semibold">{inspection.approvalStatus}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        <div className={`w-3 h-3 rounded-full ${inspection.pdfReady ? 'bg-green-400' : 'bg-gray-400'}`}></div>
