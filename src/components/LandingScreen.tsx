      ...
      <div className="flex-1 flex flex-col items-center justify-start px-6 pt-8 pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {steps.map((step, index) => (
                <motion.div
                  ...
                  className="bg-dark-800 rounded-2xl p-4 border border-blue-500/20"
                >
                  <div className="text-center">
                    <div 
        ...
        >
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold py-4 px-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-3"
          >
